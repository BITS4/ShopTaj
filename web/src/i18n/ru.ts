...
const ru: Translations = {
  ...
  home: {
    ...
    hero_sub:
      'Покупайте последние тренды с быстрой доставкой, лёгким возвратом и безопасной оплатой.',
  ...
  success: {
    ...
    message:
      'Спасибо за покупку. Подтверждение отправлено на вашу почту. Мы уведомим вас, когда заказ будет отправлен.',
