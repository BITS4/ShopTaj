...
const ru: Translations = {
  ...
  home: {
    hero_badge: 'Новинки каждую неделю',
  ...
  profile: {
    ...
    sending_otp: 'Отправка…',
    enter_otp: 'Введите 6-значный код из SMS',
    verify_otp: 'Подтвердить',
    verifying_otp: 'Проверка…',
    otp_sent: 'Код отправлен! Проверьте SMS.',
